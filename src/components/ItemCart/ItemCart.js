...
const ItemCart= () => {
  ...
  return (<>
    ...
    <h2 className="text-center my-5" > Total: ${totalToPay}</h2> 
       ...
       <button style={{color: 'white'}} className="btn btn-secondary fw-bold mx-3 px-4" onClick ={()=>navigate("/")}>Seguir Comprando</button>
       <button style={{color: 'white'}} className="btn btn-secondary fw-bold mx-3 px-4" onClick={clearCart}>Vaciar Carrito</button>
       <button style={{color: 'white'}} className="btn btn-secondary fw-bold mx-3 px-4"
       onClick={()=>
